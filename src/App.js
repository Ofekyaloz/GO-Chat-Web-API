...
function App() {
    ...
    const Login = async details => {
        ...
        fetch(localhost + 'Users/Login', {  // Enter your IP address here
            method: 'POST',
            mode: 'no-cors',
    ...
    async function find(name) {
        const res = await fetch('http://localhost:7200/api/contacts/' + name)
        return res.ok;
    }
    ...
    const Register = details => {
        ...
        fetch('http://localhost:7200/Users/register', {  // Enter your IP address here
            method: 'POST',
            mode: 'cors',
            body: JSON.stringify(jsonData) // body data type must match "Content-Type" header
        }).then(res => {

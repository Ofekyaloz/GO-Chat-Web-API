                ...
                <div>
                    ...
                    <form className="row g-3">
                        ...
                        <div className="col-md-3">
                            ...
                            <select className="form-select is-invalid" id="validationServer04"
                        ...
                        <div className="col-md-3">
                            ...
                            <input type="text" className="form-control is-invalid" id="validationServer05"
                                   aria-describedby="validationServer05Feedback" required></input>
                        ...
                        <div className="col-12">
                            <div className="form-check">
                                <input className="form-check-input is-invalid" type="checkbox" value=""
                                       id="invalidCheck3" aria-describedby="invalidCheck3Feedback" required></input>
                    ...
                    <div>
                        <a href="#" className="link-primary">
                            <label>Fot account?</label>
                        </a>
                        <a href="SignUp.js" className="link-primary">
